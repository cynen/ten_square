package com.myth.recruit.controller;
...
import com.myth.recruit.service.RecruitService;
...
public class RecruitController {
    ...
    public Result findTop10ByStateNotOrderByCreatetimeDesc() {
        return new Result(true, StatusCode.OK, "查询成功", recruitService.findTop10ByStateNotOrderByCreatetimeDesc());
    }
