package com.myth.qa.controller;
...
import com.myth.qa.service.ProblemService;
...
public class ProblemController {
	...
	public Result add(@RequestBody Problem problem  ){
		...
		problemService.add(problem,claims);
	...
	public Result newlist(@PathVariable String label,@PathVariable int page,@PathVariable int size){
		// List<Problem> list = problemService.newlist(label);
