...
import com.myth.user.service.UserService;
...
public class UserController {
	 ...
	 * code是验证码.
	 */
	@RequestMapping(value="/registry/{code}",method= RequestMethod.POST)
	public Result userRegistry(@RequestBody User user,@PathVariable String code){
		// 1.校验验证码即可.
		// String mobile = user.getMobile();
		String checkcode = (String) redisTemplate.opsForValue().get("code_"+user.getMobile());
        System.out.println("获取到的验证码: " + checkcode);
